...
public class Task06
{
	...
	public static String foafEmailURI = foafNS+"knows";
	...
	public static void main(String args[]){
		...
		// ** TASK: Add to the individual JaneSmith the fullName,given and family names **
		janeSmith.addProperty(VCARD.FN,"Jane Smith");
		janeSmith.addProperty(VCARD.Given,"Jane");
		janeSmith.addProperty(VCARD.Family,"Smith");
		// ** TASK 6.6: Add UPM as the university where Jonh Smith works **
