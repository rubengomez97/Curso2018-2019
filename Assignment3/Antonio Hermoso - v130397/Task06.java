...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Property p = model.createProperty(foafNS+"worksIn");
		...
		Individual john = researcher.createIndividual(ns+"JaneSmith");
		university.addLiteral(VCARD.Locality, "UPM");
		john.addProperty(p, university);
