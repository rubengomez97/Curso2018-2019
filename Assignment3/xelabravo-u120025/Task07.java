...
public class Task07
{
	...
	public static void main(String args[])
	{
		...
		*/
		...
		ExtendedIterator listsublcass = personInf.listInstances();
		while (listsublcass.hasNext()) {
			OntClass sublist = (OntClass) listsublcass.next();
			System.out.println(sublist.getURI());
 		}
	}
}
