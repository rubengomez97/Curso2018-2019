...
public class Task06 {
	...
	public static void main(String args[]) {
		...
		Property works_in = model.createProperty(ns + "worksIn");

		// ** TASK 6.4: Create a new individual of Researcher named "Jane Smith" **
		Individual jane_smith = model.createIndividual(ns + "Jane Smith", researcher);

		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and family
		// names **
		...
		john_smith.addProperty(works_in, upm);
