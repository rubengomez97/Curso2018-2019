...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		System.out.println("Create a new class named \"University\"");
		OntClass university = model.createClass(ns+"University");
		
		// ** TASK 6.2: Add "Researcher" as a subclass of "Person" **
		System.out.println("Add \"Researcher\" as a subclass of \"Person\"");
		OntClass person = model.createClass(ns+"Person");
		person.addSubClass(researcher);
		// ** TASK 6.3: Create a new property named "worksIn" **
		System.out.println("Create a new property named \"worksIn\"");
		Property worksIn = model.createProperty(ns + "worksIn");
		
		// ** TASK 6.4: Create a new individual of Researcher named "Jane Smith" **
		System.out.println("Create a new individual of Researcher named \"Jane Smith\"");
		Individual janeSmith = researcher.createIndividual(ns+"Jane Smith");
		
		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and family names **
		System.out.println("Add to the individual JaneSmith the fullName, given and family names");
		janeSmith.addLiteral(VCARD.Given, "Jane");
		janeSmith.addLiteral(VCARD.Family, "Smith");
		// ** TASK 6.6: Add UPM as the university where John Smith works **
		System.out.println("Add UPM as the university where John Smith works");
